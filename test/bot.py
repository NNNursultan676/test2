...
async def process_recurring_notifications(context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.info(f"Processing recurring notifications at {current_time} on {current_day}")
        ...
        for notification in recurring_notifications:
            ...
            try:
                ...
                interval_seconds = notification.get('repeat_interval_seconds', 86400)  # Default 24 hours
                ...
                # Send notification to group with thread_id 4
